        ...
        <div className="qualification__sections">
          ...
          >
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              <div>
                <h3 className="qualification__title">Master Of Coputer Applications🎓</h3>
                <span className="qualification__subtitle">Kongu Engineering College - Erode</span>
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              ...
              <div>
                ...
                <span className="qualification__subtitle">Vellalar College For Women - Erode</span>
                <div className="qualification__calender">
             ...
             <motion.div className="qualification__data" variants={dataVariants}>
              <div>
                ...
                <span className="qualification__subtitle">Rajendran Matric Higher Secondary School</span>
                <div className="qualification__calender">
